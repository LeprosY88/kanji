...
public class StationProviderStub {
	...
	public static List<Station> getStations(){
		...
		station1.setCoordinatesFromString("0;0");
				
		Station station2 = new Station();
		station2.setId(2);
		station2.setName("Essen");
		station2.setCoordinatesFromString("-19;2");
